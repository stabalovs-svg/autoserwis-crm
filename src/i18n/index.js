...
const messages = {
  ...
  en: {
    ...
    details: 'Spare Parts',
    inventory: 'Warehouse',
    addPart: 'Add a spare part',
    newPart: 'New spare part',
    partName: 'Part name',
    article: 'Part number',
    quantity: 'Quantity',
    buyPrice: 'Purchase price',
  ...
  bg: {
    ...
    inventory: 'Склад',
    addPart: 'Добавяне на резервна част',
    newPart: 'Нова резервна част',
    partName: 'Част име',
    артикул: 'Номер на част',
    количество: 'Количество',
    купуваЦена: 'Покупна цена',
    продажбаЦена: 'Продажна цена',
    password: 'Парола',
    signIn: 'Вход',
  ...
  lv: {
    ...
    password: 'Parole',
    signIn: 'Ienākt',
    loginError: 'Nederīgs e-pasts vai parole',
    ...
    inventory: 'Noliktava',
    addPart: 'Pievienot rezerves daļu',
    newPart: 'Jauna rezerves daļa',
    partName: 'Detaļa name',
    article: 'Detaļas numurs',
    quantity: 'Daudzums',
    buyPrice: 'Pirkuma cena',
    sellPrice: 'Pārdošanas cena',
